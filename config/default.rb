...
$SEARCH_SERVER_URL = "http://localhost:8983/solr" unless $SEARCH_SERVER_URL

$REPOSITORY_FOLDER = "./test/data/ontology_files/repo" unless $REPOSITORY_FOLDER

$REST_URL_PREFIX = "http://data.bioontology.org/" unless $REST_URL_PREFIX
