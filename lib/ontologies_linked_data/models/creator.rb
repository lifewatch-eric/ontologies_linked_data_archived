...
module LinkedData
  module Models
    class Creator < LinkedData::Models::Base
      ...
      #serialize_default :nameType, :givenName, :familyName,:creatorName, :creatorIdentifiers, :affiliations
      ...
      #   #     if ! value.is_a?(Array)
      #   #       new_match_item[attribute.to_sym] = value
      #   #       new_match << new_match_item
      #   #     end
      #   #   end
      ...
      #   #       value.each do |v|
      #   #         new_match_item[attribute.to_sym] = value
      #   #         where_statement = where_statement.and(new_match_item)                
      #   #       end            
      #   #     end
      #   #   end
      #   # end
